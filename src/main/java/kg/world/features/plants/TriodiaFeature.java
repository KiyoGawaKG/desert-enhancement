...
public class TriodiaFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("desert_enhancement:triodia", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(BlockStateProvider.simple(DesertEnhancementModBlocks.TRIODIA.get().defaultBlockState())),
						List.of(), 56));
		PLACED_FEATURE = PlacementUtils.register("desert_enhancement:triodia", CONFIGURED_FEATURE,
